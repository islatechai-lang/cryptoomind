...
export async function purchaseCredits(context?: { experienceId?: string; companyId?: string }): Promise<boolean> {
  ...
  try {
    console.log("[Payment] Creating checkout configuration with context:", context);
